...
| node26 | 10.206.196.155 | **KU 共享清单新增,ready;未做本轮只读体检** |
| node27 | 10.206.196.151 | **KU 共享清单新增,ready;未做本轮只读体检** |
| node28 | 10.206.196.160 | **KU 共享清单新增,ready;未做本轮只读体检** |
| node29 | 10.206.196.161 | **KU 共享清单新增,ready;未做本轮只读体检** |
| node32 | 10.206.192.96 | **KU 共享清单新增,ready;未做本轮只读体检** |
| node34 | 10.206.192.94 | **KU 共享清单新增,ready;未做本轮只读体检** |
| node60 | 10.206.192.158 | **KU 共享清单新增,ready;未做本轮只读体检** |
| node61 | 10.206.192.159 | **KU 共享清单新增,ready;未做本轮只读体检** |
| node97 | 10.206.194.224 | **KU 共享清单新增,ready;未做本轮只读体检** |
| node98 | 10.206.196.34 | **KU 共享清单新增,ready;未做本轮只读体检** |
| node99 | 10.206.196.35 | **KU 共享清单新增,ready;未做本轮只读体检** |
| node100 | 10.206.196.36 | **KU 共享清单新增,ready;未做本轮只读体检** |
| node101 | 10.206.196.37 | **KU 共享清单新增,ready;未做本轮只读体检** |
| node102 | 10.206.195.216 | **KU 共享清单新增,ready;未做本轮只读体检** |
| node103 | 10.206.195.217 | **KU 共享清单新增,ready;未做本轮只读体检** |
| node104 | 10.206.196.24 | **KU 共享清单新增,ready;未做本轮只读体检** |
| node105 | 10.206.196.25 | **KU 共享清单新增,ready;未做本轮只读体检** |
| node106 | 10.206.196.103 | **KU 共享清单新增,ready;未做本轮只读体检** |
| node107 | 10.206.196.104 | **KU 共享清单新增,ready;未做本轮只读体检** |
| node108 | 10.206.194.207 | **KU 共享清单新增,ready;未做本轮只读体检** |
| node109 | 10.206.192.170 | **KU 共享清单新增,ready;未做本轮只读体检** |
| node110 | 10.206.192.219 | **KU 共享清单新增,ready;未做本轮只读体检** |
| node111 | 10.206.192.220 | **KU 共享清单新增,ready;未做本轮只读体检** |
| node112 | 10.206.192.221 | **KU 共享清单新增,ready;未做本轮只读体检** |
| node113 | 10.206.192.222 | **KU 共享清单新增,ready;未做本轮只读体检** |
| node114 | 10.206.192.223 | **KU 共享清单新增,ready;未做本轮只读体检** |
...
### 新增共享机器池：首次只读体检结果（2026-09-01）

Ku 文档新增的 26 台共享 P800 节点不能仅凭文档 `ready` 放行。首次批量只读体检结果为：6/26 可登录且 `docker ps` 成功，5 台暂列资源候选（node108、node109、node111、node112、node114）；node34 虽可登录但当时 load 很高，降级处理；其余 20 台因 `banner timeout`/`relay closed` 未验证。该结果只证明只读连通性和粗略资源条件，不证明目标镜像、bridge、写盘权限或 M300 测试环境已就绪。

批量探测若要判断 relay 并发上限，必须另做 1→2→4→8→16→26 的阶梯实验，并关闭 ControlMaster；不能把单次并发失败直接归因于节点不可达。候选节点的后续放行仍需由执行者完成环境自证和最小 execute 冒烟。
